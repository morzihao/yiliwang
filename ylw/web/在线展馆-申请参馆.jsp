...
<body>
	...
	<div class="content container no-ovl">
		...
		<div class="all_center con-showroom">
			...
			<dl>
				<dd>
					<div class="booth-showroom">
						<a href="javascript:;" class="list-pic"><img src="images/default-onlineExhibition.jpg" alt=""></a>
						<div class="list-detail">
							<h6>目前参展公司:</h6>
							<p>深圳市XXX公司</p>
							<a href="javascript:;">申请展位</a>
							<div class="date">
								预定开始日期：<span>2014.08.01</span>
							</div>
					    </div>
					</div>
					<!-- 展位号 -->
					<span class="booth-num">01</span>
					<!-- 展位号结束-->
	    		</dd>
	    		<dd>
					<div class="booth-showroom">
