...
<body>
     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
        	...
        	<div class="content noborder">
                ...
                <div class="ddcx">
                    <form action="#">
                    	<div class="xdsj" style=" background: #f7f7f7; margin: 0; padding-top: 5px; text-align: right; border: 1px solid #d8d8d8; box-sizing:border-box;">
                        <label for="ddh">
                            <p>作品名称：</p>
                            <input type="text" id="ddh" class="w170">
                        </label>
                ...
                <!-- 作品查询 结束 -->
        		<!-- 操作按钮 -->
        		<div class="operating-works">
        			<a href="javascript:;" id="add-works">增加</a>
        			<a href="javascript:;" id="delete-works">删除</a>
        			<a href="javascript:;" id="close-works">关闭</a>
        		</div>
        		<!-- 操作按钮 结束 -->
        		<!-- 我的标车 -->
        		<div class="my-tendersCart">
        			<table>
	                    <thead>
	                      <tr>
	                        <th style="width:50px;"><input type="checkbox" class="checkbox all-check" id="allCheck"> <label for="allCheck">全选</label></th>
	                        <th style="width:350px;">商品信息</th>
	                        <th style="width:100px;">单价(元)</th>
	                        <th style="width:300px;">发布时间</th>
	                        <th style="width:100px; text-align: left; text-indent: 10px;">状态</th>
	                        <th>操作</th>
	                      </tr>
	                    </thead>
	                    <tbody>
	                    	<tr>
		                        ...
		                        <td class="prices">7.00</td>
		                        <td class="times"><p>2014-07-10 11:12:25</p></td>
		                        <td class="operation">
		                            <a href="javascript:;" class="shanchu">正常</a>
		                        </td>
		                        <td><a href="javascript:;" class="bj">编辑</a></td>
	                        </tr>
	                        <tr>
		                        <td><input type="checkbox" class="checkbox"></td>
		                        <td class="goods"><a href="javascript:;">
		                        ...
		                        <td class="times"><p>2014-07-10 11:12:25</p></td>
		                        <td class="operation">
		                            <a href="javascript:;" class="shanchu">关闭</a>
		                        </td>
		                        <td><a href="javascript:;" class="bj">编辑</a></td>
	                        </tr>
	                       	<tr>
	...
	$(function(){
	    ...
	    $('#delete-works').click(function(){
	    	$('.my-tendersCart tr').each(function(){
	    		if($(this).find('td .checkbox').attr('checked') == 'checked'){
	    			$(this).remove();
	    		}
	    	});
	    });
