     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
        	...
        	<div class="content noborder">
                ...
                <!-- 联系方式 结束-->
                <!-- 竞标信息 -->
				 <dl class="add-sort page-floor infor-jingbiao">
                    <dt><p>竞标信息</p>
                    	<a href="javascript:;" class="my-cart">
							<img src="images/icons/cart-icon01.png" alt="">
							<p>标车(<span>0</span>)件</p>
						</a>
			       </dt>
	                <dd>
	                	<div class="column-inforTenders">
		                   	<h6>竞标者：</h6>
		                   	<div class="content-inforTenders">
		                   		<p>广东深圳- 李生 - 15084904908 - 深圳市XXX公司</p>
		                   	</div>
	                   </div>
	                   <div class="column-inforTenders">
		                   	<h6>竞标礼品：</h6>
		                   	<div class="content-inforTenders">
		                   		<ul>
		                   			<li>
										...
										<a href="javascript:;" class="cartSelected">加入标车</a>
					    			</li>
					    			<li>
					    				<div class="list-pic">
										<img src="images/icons/pic-onlineChakan.jpg" alt="">
										...
										<a href="javascript:;" class="add-tendersCart">加入标车</a>
					    			</li>
					    			<li>
					    				<div class="list-pic">
										<img src="images/icons/pic-onlineChakan.jpg" alt="">
