...
<body>
			...
			<!-- 设计师主体 -->
			 <div id="lib_Tab1" class="lib_Tab1">
                <div class="lib_Menubox lib_tabborder">
                    <ul>
                       <li id="two1" class="hover"><a href="设计师-设计师展示更多页面.html">设计师展示</a></li>
                       <li id="two2" class=""><a href="设计师-案例展示更多页面.html">案例展示</a></li>
                    </ul>
                </div>
                <div class="lib_Contentbox lib_tabborder">
                   <div id="con_two_1" style="display: block;">
                      ...
                      <dl class="list-designers">
						<dd><a href="designer-details-13.html">
							<div class="mask"></div>
							...
							<div class="infor-person">
								...
								<p>一路向北</p>
							    <span>
							    	<div class="bdsharebuttonbox" data-tag="share_1" style="margin-top: 10px; margin-left: 122px;">
						...
						<dd><a href="http://www.baidu01.com">
						...
						<dd><a href="http://www.baidu03.com">
	...
	<script type="text/javascript">
		$('.list-designers>dd').each(function(){
			var DomainName='http://ylw.160it.net/';
			var Txturl = DomainName +$(this).children('a').attr('href');
			window._bd_share_config = {
				common : {
					bdText : '易礼网中国最大的礼品交易服务平台之一',
					bdDesc : '易礼网中国最大的礼品交易服务平台之一',
					bdUrl : Txturl
				},
				share : [{
					"bdSize" : 16
