        ...
        <div class="member_right">
        	...
        	<div class="content margbot">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th class="td-center">退货编号</th>
                            <th class="td-center">订单号</th>
                            <th>商品名称</th>
                            <th class="td-center">实付金额</th>
                            <th class="td-center">申请退款金额</th>
                            <th class="td-center">退款申请时间</th>
                            <th class="td-center">退款状态</th>
                    ...
                    <tbody>
                        <tr>
                            <td class="td-center">
                                <div class="p-div"><span class="number">B16900444087</span></div>
                            </td>
                            <td class="td-center">
                                <div class="p-div"><span class="number">16900444087</span></div>   
                            </td>
                            <td>
                                 <div class="p-info">
                            ...
                            <td class="td-center">
                               <div class="time">¥<b>1500.00</b></div>
                            </td>
                            <td class="td-center">
                                 <div class="p-price">¥<b>1500.00</b></div>
                            </td>
                            <td class="td-center">
                                <div class="p-div"><span class="number">2014-10-12</span></div>
                                <div class="p-div"><span class="number">12:30:34</span></div>
                            </td>
                            <td class="td-center">
                                <div class="p-div"><a href="#" class="btn btn-mini">确认退货</a></div>
                                <div class="p-div"><a class="btn btn-mini" rel="leanModal" href="#popver?id=5" name="#popver">拒绝退货</a></div>
                            </td>
                            <td class="td-center">
                         ...
                         <tr>
                            ...
                            <td class="td-center">
                                <div class="p-div warning">已拒绝退货</div>
                            </td>
                            <td class="td-center">
                                <a href="#" target="_blank">查看详情</a>
                            </td>
                         ...
                         <tr>
                            ...
                            <td class="td-center">
                                <div class="p-div"><a href="#" class="btn btn-mini">签收</a></div>
                                <div class="p-div"><a href="#" >物流信息</a></div>
                            </td>
                            <td class="td-center">
                                <a href="#" target="_blank">查看详情</a>
                            </td>
