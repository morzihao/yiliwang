...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
    .content-regtister form div.error .controls input.error{ border-color:#c40000;color: #c40000;}
    .content-regtister form div.error .controls .error{color: #c40000;}
    .content-regtister form div.success .controls input{border-color:#468847;color:#468847;}
    .content-regtister form div .valid{border-color:#468847;}
    </style>
	<!--[if lt IE 10]>
...
<body>
	...
	<div class="content container">
			...
			<p>恭喜您！注册成功</p>
			<a href="javascript:;" class="back-login">马上登录去完善您的个人资料</a>
	</div>
		<!-- 右侧悬浮菜单 -->
