        ...
        <div class="member_right mb40">
        	...
        	<div class="content noborder">
                ...
                <dl class="list-ddcx">
                  <dt><p>订单状态：</p><a href="javascript:;">全部 </a><a href="javascript:;">已付款</a><a href="javascript:;">带设计提交</a><a href="javascript:;">待签收</a><a href="javascript:;">交易成功</a><a href="javascript:;">已放弃设计</a></dt>
                   <dd>
                      ...
                      <p style="width: 150px;margin-left: 67px;">订单状态</p>
                      <p style="width: 56px; margin-left: 190px;">交易操作</p>
                  </dd>
                </dl>
                <!-- 订单查询列表 结束 -->
                <!-- 导出订单 -->
                ...
                <div class="content-cxlb">
                  <table class="designers-works gmsj">
                    <!-- 已付款-->
                    <tr>
                      <td>
                        <table>
                          <thead>
                            <tr>
                              ...
                              <th colspan="2" style="text-align: right; padding-right: 20px;">订单详情</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              ...
                              <td class="detail-designers">已付款</td>
                              <td colspan="2" class="designers-help"></td>
                              <td class="beiwang">
                                <div id="beiwang">
                                   <a href="javascript:;" class="btn-beiwang">申诉</a>
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="detail-designers">待设计提交</td>
                              <td colspan="2" class="designers-help"></td>
                              <td class="beiwang">
                                <div id="beiwang">
                                   <a href="javascript:;" class="btn-beiwang">申诉</a>
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="detail-designers">
                                <p>待签收</p>
                                <a href="javascript:;">确认签收</a>
                              </td>
                              <td  colspan="2" class="designers-help">
                               <!--  <a href="images/icons/pic-onlineChakan.jpg" class="" class="fresco" data-fresco-group="unique_name">查看附件</a> -->
                                <a href="images/icons/pic-onlineChakan.jpg" id="chakan" class="chakan01" data-fresco-group="unique_name">查看附件</a>
                              </td>
                              <td class="beiwang">
                                <div id="beiwang">
                                   <a href="javascript:;" class="btn-beiwang">申诉</a>
