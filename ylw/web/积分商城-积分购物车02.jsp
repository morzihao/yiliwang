...
<body>
	...
	<div class="all_center">
            ...
            <!-- 订单提交内容页 -->
            <form action="#">
             <div class="order_center jifen-infor">
                    <div class="order_info">
                        <div class="area">
                            ...
                            <dl>
                                ...
                                <dd class="add-address"><a href="javascript:;" class="area4">使用新地址</a></dd>
                            </dl>
                            <div class="newAddress-jifen">
                                <ul>
                           ...
                           <!-- 订单列表 -->
            <div class="list-order my-cart">
                <table>
                    <thead>
                        <tr>
                            <th style="width:470px;">商品信息</th>
                            <th style="width:290px;">价格(元)</th>
                            <th style="width:230px;">积分（分）</th>
                            <th>卖家</th>
                        </tr>
                    </thead>
                    <tbody>
