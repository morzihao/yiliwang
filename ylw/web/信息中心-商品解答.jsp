	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        <dl>
           ...
           <dd style="border-bottom:none;"><a href="memberWashApply.html" class="selected">商品解答</a></dd>
        </dl>
        </div>
	    <!-- 会员左侧菜单结束 -->
	    <!-- 我的会员卡右侧 -->
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>水中的鱼</td>
                    <td class="goods">
                      <a href="javascript:;"><img src="images/products/GYP-other04.jpg" alt=""></a>
                      <div class="detail-goods">
                          <h6>产品编号：<span>121212121</span></h6>
                          <p>宝宝专用商品护手套</p>
                          <div class="prices">价格：￥<span>66</span></div>
                      </div>
                    </td>
                    <td>我想一种适合送给同事结婚用的纪念品。</td>
                    <td><a href="信息中心-商品解答-解答.html" class="jieda-online">解答</a></td>
                  </tr>
                  <tr>
                    <td>水中的鱼</td>
                    <td class="goods">
