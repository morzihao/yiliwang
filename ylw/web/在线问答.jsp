...
<body>
	...
	<div class="content container">
		...
		<div class="all_center">
			...
			<!-- 问题搜索 结束 -->
				<!-- 热门解答 -->
				<div class="popular-answers">
					<h5>热门解答</h5>
					<div class="column-PopAnswers">
						<dl>
							<dt>
								<h6><span>XXX会员：</span><em>中秋节送礼应该选什么商品好？</em></h6>
								<p>2014-06-18  22:14:45</p>
							</dt>
							<dd class="txt-gys">
								<h6><span>XXX供应商：</span><em>中秋节送礼可以送送传统的月饼，也可以送一些上档次的水墨画，以及瓷器产品。</em></h6>
								<p>2014-06-18  22:14:45</p>
							</dd>
							<dd class="detail"><a href="javascript:;" class="chakan">查看详情</a></dd>
						</dl>
						<dl>
							<dt>
								<h6><span>XXX会员：</span><em>中秋节送礼应该选什么商品好？</em></h6>
				...
				<!-- 热门解答 结束 -->
				<!-- 待解答 -->
				<div class="wait-answers">
					<h5>待解答</h5>
					<div class="content-WaitAnswers">
						<ul>
							<li><a href="javascript:;">
								<p><em>问：</em>中秋节送礼应该选什么商品好？</p>
					    ...
					    <!-- 换一批 -->
					    <a href="javascript:;" class="hyp">换一批</a>
					    <!-- 换一批 结束 -->
					</div>
					<!-- 广告 -->
					<div class="add-online">
						<img src="images/banner/online-add01.jpg" alt="">
					</div>
					<!-- 广告 结束 -->
				</div>
				<!-- 待解答 结束 -->
				...
				<div class="recommended-questions">
					<h5>推荐问题</h5>
					<ul>
						<li><a href="javacript:;"><p>中秋节送礼应该选什么商品好，中秋节送礼应该选什么商品好？</p></a></li>
						<li><a href="javacript:;"><p>中秋节送礼应该选什么商品好，中秋节送礼应该选什么商品好？</p></a></li>
						<li><a href="javacript:;"><p>中秋节送礼应该选什么商品好，中秋节送礼应该选什么商品好？</p></a></li>
						<li><a href="javacript:;"><p>中秋节送礼应该选什么商品好，中秋节送礼应该选什么商品好？</p></a></li>
						<li><a href="javacript:;"><p>中秋节送礼应该选什么商品好，中秋节送礼应该选什么商品好？</p></a></li>
