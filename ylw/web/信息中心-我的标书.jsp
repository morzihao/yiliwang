     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
        	...
        	<div class="content noborder">
        		<!-- 我的标书 -->
        		<div class="my-tenders">
        			<table>
        				<thead>
        					<tr>
        						<th style="width:290px;">招标信息</th>
        						<th style="width:170px;">招标状态</th>
        						<th style="width:auto;">招标者</th>
        					</tr>
        				</thead>
        				<tbody>
        					<tr>
        						<td class="infor-tenders">
        							<h6>
        								<p>招标名称：</p>
        								<span>中秋节送礼包</span>
        							</h6>
        							<div class="content-tenders">
        								<p>招标内容：</p>
        								<span>需要尽快提供礼品方案，礼品要求实惠上档次，主要是送给家里人，可能还会送一部分给很久没联系的远房亲戚，要求礼品尽量要拉近关系，联系感情需要尽快提供礼品方案，礼品要求实惠上档次，主要是送给家里人，可能还会送一部分给很久没联系的远房亲戚，要求礼品尽量要拉近关系，联系感情</span>
        							</div>
        						</td>
        						<td class="statu-tenders">正在招标</td>
        						<td class="person-tenders">
        							<!-- 招标者信息 -->
        							<div class="infor">
        								<span>南山科技园</span> - <span>李生</span> - <span>15084904908</span> - <span>深圳市XXX公司</span>
        							</div>
        							<!-- 招标者信息 结束 -->
        							<!-- 招标图片 -->
        							<div class="pic-tenders">
        							    <ul>
											<li>
							    				<div class="list-pic">
        							...
        							<div class="operation-tenders">
        								<a href="信息中心-我的标书-查看更多.html" class="chakan">查看更多</a>
        								<a href="信息中心-我的标书-我的标车.html" class="my-tendersCart">我的标车</a>
        							</div>
        							<!-- 投标操作 结束 -->
        						</td>
        					</tr>
