     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
            ...
            <div class="content noborder">
             <!--商家认证 -->
             <form action="#">
            <dl class="add-sort page-floor sjrz sczp">
                 <dd>

                    <div class="control-group up-zj">
                       <label for="" class="control-label"><span>*</span>作品上传：</label>
                    ...
                    <div class="tips"><span>*</span>文件大小最大3M。也支持gif/png格式，但建议转换为jpg后再上传</div>
                    <div class="clear"></div>
