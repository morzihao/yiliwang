	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        <dl>
           ...
           <dd><a href="javascript:;" class="selected bg">商品管理</a>
              <ul>
        	...
        	<div class="content noborder">
              ...
              <div class="ddcx">
                  <form action="#">
                      ...
                      <input type="submit" value="搜索" class="submit02">
                  </form>
                </div>
                <!-- 商品查询 结束 -->
                <!-- 导出订单 -->
                <div class="dcdd">
                  <a href="javascript:;" class="xiaJia">下架</a>
                  <a href="javascript:;" class="shanchu">永久删除</a>
                </div>
                <!-- 导出订单 结束 -->
                <!-- 查询列表 主体 -->
                <div class="content-spcx">
                  <table>
                    <thead>
                      <tr>
                        <th style="width:30px;"><input type="checkbox" class="boxCheck allCheck"> </th>
                    ...
                    <tbody>
                      <tr>
                        <td><input type="checkbox" clas="boxCheck"></td>
                        ...
                        <td class="operation">
                          <div class="left-operation">
                            <a href="javascript:;" class="xiaJia">下架</a>
                            <a rel="leanModal" href="#popver?id=5" name="#popver" class="tjts">推荐为地方特色产品</a>
                          </div>
                          <a href="javascript:;" class="right-operation">重新编辑</a>
                        </td>
                      </tr>
                       <tr>
                        <td><input type="checkbox" clas="boxCheck"></td>
                        ...
                        <td class="operation">
                          <div class="left-operation">
                            <a href="javascript:;" class="xiaJia">下架</a>
                            <a href="javascript:;" class="tjts">推荐为地方特色产品</a>
                          </div>
                          <a href="javascript:;" class="right-operation">重新编辑</a>
                        </td>
                      </tr>
