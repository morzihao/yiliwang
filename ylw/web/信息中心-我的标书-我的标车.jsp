        	...
        	<div class="content noborder">
        		...
        		<div class="my-tendersCart">
        			<table>
	                    <thead>
	                      <tr>
	                        <th style="width:50px;"><input type="checkbox" class="boxCheck allCheck" id="allCheck"> <label for="allCheck">全选</label></th>
	                        <th style="width:400px;">商品信息</th>
	                        <th style="width:100px;">单价(元)</th>
	                        <th style="width:345px;">竞争公司</th>
	                        <th>操作</th>
	                      </tr>
	                    </thead>
	                    <tbody>
	                      <tr>
	                        ...
	                        <td class="times"><p>深圳市XXX公司</p></td>
	                        <td class="operation">
	                            <a href="javascript:;" class="shanchu">删除</a>
	                            <a href="javascript:;" class="beizhu">备注</a>
	                        </td>
	                      </tr>
	                       <tr>
	                        <td><input type="checkbox" clas="boxCheck"></td>
        		...
        		<div class="delete-pro">
        			<input type="checkbox" class="boxCheck allCheck" id="allCheck01"> <label for="allCheck01">全选</label>
        			<a href="javascript:;" class="delete">删除选中商品</a>
        			<input type="button" class="submit" value="确认招标">
        		</div>
        		<!-- 删除选中商品 结束-->
