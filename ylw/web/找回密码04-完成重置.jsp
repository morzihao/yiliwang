...
<body>
	...
	<div class="content container">
		<div class="content-regtister con-forgotPassword">
			<h1 class="title">会员注册</h1>
			<div class="progress-forgotPassword">
				<dl class="liucheng">
	                <dd>
	                ...
	                <dd>
	                 ...
	                 <dd class="selected">
	                    <a href="javascript:void(0)"><img src="images/icons/liucheng-icon.png" alt=""></a>
	                    <em>完成</em>
	                </dd>
                </dl>
		    </div>
		    <div class="forgotPassword-backLogin">
		    	<p>您已完成重置密码，现在马上去</p>
