     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
            ...
            <dl class="add-sort page-floor">
                 <dt><p>页面风格设计</p></dt>
                 <dd>
                   <p><em>二级域名：</em><span>erer.yili.com</span></p>
                   <div class="page-style">
                       <p>页面风格：</p>
                       <div class="select-orderSubmit">
                         <select name="provinces">
                             <option value="1">默认风格</option>
                             <option value="2">红色风格</option>
                             <option value="3">灰色风格</option>
                             <option value="4">蓝色风格</option>
                          </select>
                       </div>
                   </div>
                 </dd>
            ...
            <!-- 第一层 -->
            <dl class="add-sort page-floor">
                 <dt><p><span>第一层：</span>店铺顶部</p></dt>
                 <dd>
                    <div class="txt-title">
                      <h6>设置店铺LOGO：</h6>
                    </div>
                    <div class="logo-pic">
                       <div class="img-upload4">
                          <div class="pic-pro" id="Div1">
                              <div id="Div2" style="margin: 30px auto; width: 282px; height: 282px; display: none;
                                  overflow: hidden;">
                              </div>
                              <img src="images/icons/pic-logo.jpg" alt="" id="imgPicture">
                          </div>
                          <input type="file" name="reqiued" class="file" id="filepic1">
                        </div>
                    </div>
                    <div class="clear"></div>
                      <div class="tips" style="margin:10px 0 0 90px; color:#666;"><span style="color:#c40000;">*</span>建议尺寸：宽(200px)*高(100px)</div>
                 </dd>
               </dl>
               <!-- 第一层 结束 -->
            <!-- 第二层 -->
            <dl class="add-sort page-floor">
                 <dt><p><span>第二层：</span>店铺顶部</p></dt>
                 <dd>
                    <div class="txt-title">
                      <h6>点击设置图片：</h6>
                      <p>图片链接：</p>
                    </div>
                    <div class="list-picFile">
                        <div class="img-upload1">
                            <div class="pic-pro" id="Div1">
                                <div id="Div2" style="margin: 30px auto; width: 282px; height: 282px; display: none;
                                    overflow: hidden;">
                                </div>
                                <img src="images/icons/icon-addPic.png" alt="" id="imgPicture">
                            </div>
                            <input type="file" name="reqiued" class="file" id="filepic1">
                    ...
                    <div class="clear"></div>
                      <div class="tips" style="margin:10px 0 0 90px; color:#666;"><span style="color:#c40000;">*</span>建议尺寸：宽(1190px)*高(最小100px)</div>
                 </dd>
               </dl>
            <!-- 第二层 结束 -->
            <!-- 第三层 -->
            <dl class="add-sort page-floor list-banner">
                 <dt><p><span>第三层：</span>Banner层</p> <div class="tips" style=" float: left; margin:0 0 0 30px;line-height: 31px; color:#666;"><span style="color:#c40000;">*</span>建议尺寸：宽(1920px)*高(475px)</div><input type="button" value="继续添加" class="goOn-banner"></dt>
                 <dd>
                  <div class="txt-title">
                    <h6>点击设置图片：</h6>
                    <p>Banner链接：</p>
                  ...
                  <div class="banner-pic">
                    <div class="img-upload3">
                        <div class="pic-pro" id="Div3">
                            <div id="Div2" style="margin: 30px auto; width: 282px; height: 282px; display: none;
                                overflow: hidden;">
                            </div>
                            <img src="images/icons/pic-banner.jpg" alt="" id="imgPicture">
                        </div>
                        <input type="file" name="reqiued" class="file" id="filepic3">
                        <input type="text" name="reqiued" class="title w170" value="Title说明">
                      </div>
                  </div>
                  <p>或上传图片链接</p>
                  <input type="text" class="link-pic w270">
            ...
            <!-- 第四层 -->
            <dl class="add-sort page-floor">
                 <dt><p><span>第四层：</span>店铺信息</p></dt>
                 <dd class="infor-shop">
                    <div class="column-shop">
                       <p>店铺信息：</p>
                       <input type="text" class="w270">
                    </div>
                    <div class="column-shop">
                       <p>店铺介绍：</p>
                       <textarea></textarea>
     ...
     function addBanner(){
       var Banner ='<dd>\
                    ...
                    <div class="banner-pic">\
                     <div class="img-upload3">\
                        <div class="pic-pro" id="Div3">\
                            <div id="Div2" style="margin: 30px auto; width: 282px; height: 282px; display: none;overflow: hidden;">\
                            </div>\
                            <img src="images/icons/pic-banner.jpg" alt="" id="imgPicture">\
                        </div>\
                        <input type="file" name="reqiued" class="file" id="filepic3">\
        ...
        $('.list-banner').append(Banner);
     }
     // 删除banner
     $('.shanchu').live({
        click:function(){
          var conf =confirm('您确定删除此Banner吗？');
          if(conf){
