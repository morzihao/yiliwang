	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        <dl>
           ...
           <dd><a href="javascript:;" class="selected">店铺管理</a>
              <ul>
                  ...
                  <li><a href="javascript:;" class="selected">保证金管理</a></li>
              </ul>
           </dd>
        ...
        <div class="member_right">
            ...
            <div class="operation-payment">
              <a href="信息中心-商铺管理-保证金管理01.html">缴纳消费者保证金</a>
              <a href="信息中心-商铺管理-保证金管理01.html">缴纳VIP服务费</a>
            </div>
            <!-- 保证金 列表 -->
            <div class="list-bzj">
              <table>
                <thead>
                  <tr>
                    <th style="width:330px;">店铺状态</th>
                    <th style="width:170px;">金额（元）</th>
                    <th style="width:240px;">缴纳时间</th>
              ...
              <p>共缴纳保证金：<span>2000.00</span>元</p>
            </div>
            <!-- 保证金列表 结束 -->
        	</div>
        </div>
