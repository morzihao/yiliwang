...
<body>
	...
	<div class="content container">
		...
		<div class="left-list-product">
			<!-- 左侧菜单列表标题 -->
			<a href="javascript:;" class="title-MenuList">地方特色礼品</a>
			<!-- 左侧菜单列表标题 结束 -->
			<!--商品列表菜单  -->
	    ...
	    <div class="right-list-product">
	    	<!-- 地区选择 -->
			<div class="area-selected" style="margin:20px 0 0 0;">
				<h6>地方特色:</h6>
			...
			<!-- 地区选择 结束 -->
			<!-- 商品筛选 -->
			<div class="goods-select" style=" margin:0 0 20px 0; padding-bottom: 10px; border-bottom:1px solid #e5e5e5;">
				<h4>
					<div class="nav-select">
						<a href="javascript:;">杯子形状</a><span>></span>
				...
				<div class="content-select">
						...
						<dl>
							<dt>场合：</dt>
							<dd class="defualt">
								<a href="javacript:;" class="selected">婚礼</a>
								<a href="javacript:;">庆典</a>
								<a href="javacript:;">婚礼</a>
								<a href="javacript:;">庆典</a>
						    </dd>
						    <dd class="collapse">更多</dd>
						</dl>
						<dl>
							<dt>用途：</dt>
							<dd>
								<a href="javacript:;">欧美风格</a>
								<a href="javacript:;">中式风格</a>
						    </dd>
						</dl>
						<dl>
							<dt>风格：</dt>
						...
						<dl>
							<dt>加印LOGO：</dt>
							<dd>
								<a href="javacript:;"><input type="radio" name="radio" id="radio01"><label for="radio01">是</label></a>
								<a href="javacript:;"><input type="radio" name="radio" id="radio02"><label for="radio02">否</label></a>
						    </dd>
						</dl>
						<dl>
							<dt>定制：</dt>
							<dd>
								<a href="javacript:;"><input type="radio" name="radio-dingzhi" id="radio03"><label for="radio03">是</label></a>
								<a href="javacript:;"><input type="radio" name="radio-dingzhi" id="radio04"><label for="radio04">否</label></a>
						    </dd>
						</dl>
					</div>
			</div>
