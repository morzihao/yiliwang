...
<body>
	...
	<div class="content container">
		...
		<div class="all_center con-designers">
			<a href="javascript:;" class="banner-designers container">
				<img src="images/banner/deginsers-personBanner01.jpg" alt="">
			</a>
		</div>
		<!-- 个人资料 -->
		<table class="infor-designersPerson">
			<tr>
				<td class="designersPerson-tit">
					<img src="images/icons/deginsers-personTouxiang.jpg" alt="">
					<div class="detail">
						<h6>XXX设计师</h6><a href="javacript:;"><img src="images/icons/icon-qqJiaotan.jpg" alt=""></a>
					</div>
				    <p><em>特长：</em><span>包装创意设计，场地布置设计，从业十年</span></p>
				</td>
				<td class="designersPerson-address">深圳</td>
				<td class="designersPerson-contacts">
					<p>联系方式</p>
				    <p>18245102972</p>
				</td>
		    </tr>
		...
		<!-- 个人介绍 结束 -->
		<!-- 案例展示 -->
		<div class="alzs-designersPerson">
			<h6><p>案例展示</p></h6>
			<ul>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic01.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic02.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic03.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic04.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic05.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic06.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic07.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
				<li><a href="javascript:;">
					<img src="images/products/deginsers-personPic08.jpg" alt="">
					<p>月饼包装袋设计</p>
				</a></li>
			</ul>
		</div>
