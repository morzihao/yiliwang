        	...
        	<div class="content noborder">
        		<form action="#">
	                <table class="list-Tenders">
	                	<thead>
	                		<tr>
	                			<th style="width:200px;">设计任务信息</th>
	                	...
	                	<tbody>
	                		<tr class="bidding">
	                			<td class="infor">
	                				<h6>纪念日 -  古典风</h6>
	                				<p>任务简介：<span>在1000元范围内选择中秋节礼品，可以是一款产品页可以是多款产品，必须在中秋节前能把礼品送到</span></p>
	                			</td>
	                			<td  class="bid-status"><span>正在进行</span></td>
	                			<td>
	                				<div class="infor-companyTenders"> 李生 - 15084904908</div>
	                				...
	                				<div class="operation-tenders">
        								<a href="信息中心-设计任务详情页.html" class="chakan">查看更多</a>
        							</div>
	                			</td>
	                		</tr>
	                		<tr class="bid">
	                			...
	                			<td class="bid-status"><span>已完成</span></td>
	                			<td>
	                				<div class="infor-companyTenders">李生 - 15084904908</div>
	                				<div class="list-companyTenders">
	                					<ul>
	                		...
	                		<tr class="bid-completed">
	                			...
	                			<td class="bid-status"><span>已完成</span></td>
	                			<td>
	                				<div class="infor-companyTenders">南山科技园 - 李生 - 15084904908 - 深圳市XXX公司</div>
	                				<div class="list-companyTenders">
	                					<ul>
											<li>
							    				<div class="list-pic">
