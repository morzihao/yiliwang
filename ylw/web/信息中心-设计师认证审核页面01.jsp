	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        ...
        <div class="member_right">
        	...
        	<div class="content">
            <div class="txt-cgfb">
              <p style="background: none; font-size: 40px; margin-bottom: 0;">您好！您申请成为设计师正在审核中，</p>
              <p style="background: none; font-size: 40px; margin-bottom: 0;margin-top: 0;">请耐心等待审核结果</p>
              <p style="background: none; font-size: 14px; color:#666; margin-top: 0;">审核结果将在两个工作日内以手机短信的形式告知您，敬请关注！</p>
            </div>
        	</div>
        </div>
	    <!-- 我的会员卡右侧结束 -->
