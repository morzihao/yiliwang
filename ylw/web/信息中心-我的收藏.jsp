	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        <dl>
           ...
           <dd><a href="memberPurchaseHistory.html" class="selected">我的收藏</a></dd>
        ...
        <div class="member_right">
          	...
          	<div class="content noborder">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="p-info">
                            ...
                            <div class="p-extra">评价：<b>12345</b></div>
                          </div>
                        </td>
                        <td>
                          <a href="#">淄博联业商贸有限公司供应商</a>
                        </td>
                        <td>
                          我是谁呢
                          <a href="#" class="btn btn-primary disabled"><i class="icon-qq"></i>QQ交谈</a>
                        </td>
                        <td>
                          <div class="addcart"><button class="btn btn-danger btn-mini">加入购物车</button></div>
                          <div class="del"><button class="btn">删除</button></div>
                        </td>
                      </tr>
                      <tr>
                        <td>
               ...
               <div class="pagination">
                   <label for="" class="checkbox inline"><input type="checkbox">全选</label>
                   <a href="#" class="btn btn-mini delAll">删除选中</a>
               </div>
        	  </div>
             <!-- page -->
      <div class="pagination">
