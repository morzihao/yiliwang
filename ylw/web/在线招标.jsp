			...
			<!-- 竞标主体 -->
			 <div id="lib_Tab1" class="lib_Tab1">
                <div class="lib_Menubox lib_tabborder">
                    <ul>
                       <li id="three1" onclick="setTab('three',1,3)" class="hover">全部竞标</li>
                       <li id="three2" onclick="setTab('three',2,3)" class="">正在进行的竞标</li>
                       <li id="three3" onclick="setTab('three',3,3)" class="">已结束的竞标</li>
                    </ul>
                    <a href="javascript:;" class="fbxx">发布信息</a>
                </div>
                <div class="lib_Contentbox lib_tabborder">
                   <div id="con_three_1" style="display: block;">
                   	<!-- 正在招标 -->
                   	<div class="now-bidding">
                   		 <dl>
							<dd><a href="javascript:;">
								<div class="now-biddings">
									<h6>400套校庆礼品</h6>
									<p>正在进行中...</p>
									<div class="Countdown">
										还剩5天4小时20分
                   	...
                   	<!-- 正在招标 结束-->
                   	<!-- 完成招标 -->
                     <div class="over-bidding">
                     	<dl>
	                     	<dd><a href="javascript:;">
								<div class="over-biddings">
									<h6>200套会议礼品</h6>
									<p>招标已结束</p>
								</div>
							</a></dd>
					...
					<div class="list-page">
                        <ul>
                            ...
                            <li style="border-bottom-style: none;"><a href="javascript:;" class="jump-page">确定</a></li>
                        </ul>
                    </div>
                    <!-- page over -->
                </div>
