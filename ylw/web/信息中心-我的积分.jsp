	...
	<!-- 内容 -->
     ...
     <div  class="member_left_menu">
        <dl>
	         ...
	         <dd><a href="memberCard.html" class="selected">我的积分</a></dd>
        ...
        <div class="member_right">
        	...
        	<div class="content noborder">
	            ...
	            <div class="introduction">
	                ...
	                <a href="javascript:;" class="go-jfsc">去积分商城</a>
	            </div>
	            <!-- 板块介绍 结束 -->
        		<!-- 积分明细 -->
        		<div class="jfmx">
        			...
        			<table>
        				<thead>
        					<tr>
        						<th style="width:360px;">来源/用途</th>
        						<th style="width:236px;">积分变化</th>
        				...
        				<tbody>
        					<tr>
        						...
        						<td class="time">2014年7月24日 14:40:05</td>
        						<td class="remarks">交易获得</td>
        					</tr>
        					<tr>
        						<td class="goods">
        							<img src="images/products/GYP-other04.jpg" alt="">
