	    ...
	    <div class="right-list-product con-search">
			...
			<div class="list-goods-select">
				<table>
					<tbody>
						<tr>
							<td class="infor"><img src="images/icons/shop-logo.jpg" alt=""></td>
							<td class="name"><a href="javacript:;">店铺名称：<span>深圳礼品公司</span></a></td>
							<td class="intro"><p><a href="javascript:;">店铺介绍：<span>深圳礼品公司是一家拥有着资深背景，专注于礼品解决方案20年的老字号商家，可以承接婚礼、生日、宴会、过年、送礼等定制化解决方案的礼品公司。</span></a></p></td>
							<td class="level">店铺等级：<span>一星</span></td>
							<td class="place">广东省深圳市</td>
							<td class="enter-shop"><a href="javascript:;">进入店铺</a></td>
						</tr>
						<tr>
							<td class="infor"><img src="images/icons/shop-logo.jpg" alt=""></td>
							<td class="name"><a href="javacript:;">店铺名称：<span>深圳礼品公司</span></a></td>
