	...
	<div class="content container">
		...
		<div class="points-banner">
			<div id="bannerBox">
				...
				<div id="bannerImg">
			    	<ul>
			        	<li><a href="javascript:void(0)"><img src="images/banner/jifen-banner01.jpg"></a></li>
			            <li><a href="javascript:void(0)"><img src="images/banner/jifen-banner01.jpg"></a></li>
			            <li><a href="javascript:void(0)"><img src="images/banner/jifen-banner01.jpg"></a></li>
			        </ul>
			    </div>
		...
		<div class="points-column">
			<a href="javascript:;"><img src="images/products/jifen-columnPic01.jpg" alt=""></a>
			<a href="javascript:;"><img src="images/products/jifen-columnPic02.jpg" alt=""></a>
		</div>
		<!-- 积分商城边栏 结束-->
		<div class="all_center con-designers con-jfsc">
			<!-- 积分商城列表 -->
			 <div id="lib_Tab1" class="lib_Tab1">
                <div class="lib_Menubox lib_tabborder">
                    <ul>
                       <li id="two1" onclick="setTab('two',1,2)" class="hover">积分</li>
                       <li id="two2" onclick="setTab('two',2,2)" class="">上架时间</li>
                    </ul>
                </div>
                <div class="lib_Contentbox lib_tabborder">
                   <div id="con_two_1" style="display: block;">
                      ...
                      <dl class="list-jfsc">
						<dd>
							<a href="javascript:;">
							<img  class="show-pic" src="images/products/Gyp-Pro01.jpg" alt="">
							</a>
							<div class="points"><span>2346</span>积分</div>
							<h6>XXX品牌最具特色杯子形状玻璃工艺品（最具创意）</h6>
							<a href="javascript:;" class="exchange">查看详情</a>
							<div class="mask"></div>
                        </dd>
                        <dd>
							<a href="javascript:;">
