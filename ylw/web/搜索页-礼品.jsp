...
<body>
	...
	<div class="content container">
		<!-- 标题导航 -->
		<h5 class="nav-title search-title">
			<a href="javascript:;">所有分类</a>
			<span>></span>
			<a href="javascript:;" class="search-keyword">关键字</a>
		</h5>
		<!-- 标题导航结束 -->
	    <!-- 商品列表内容 -->
	    <!-- 商品列表右侧 -->
	    <div class="right-list-product con-search">
	    	<!-- 商品筛选 -->
						...
						<dl class="gift-changeArea">
							...
							<dd>
				                ...
				                <div class="prices-change">
				                	...
				                	<span>-</span>
				                	<input type="text">
				                	<input type="submit" value="确定" class="sub-giftChange">
				                </div>
						    </dd>
						</dl>
					</div>
			...
			<div class="area-selected">
				<h6>以下为您找到的关于<span>"关键字"</span>的结果：&nbsp;共有<span>9756</span>个查询结果</h6>
			</div>
			<!-- 查询结果结束 -->
