        	...
        	<div class="content noborder">
        		<form action="#">
	                ...
	                <table class="list-Tenders">
	                	<thead>
	                		<tr>
	                			<th style="width:200px;">招标信息</th>
	                			<th style="width:150px;">招标状态</th>
	                			<th>我的商品</th>
	                		</tr>
	                	</thead>
	                	<tbody>
	                		<tr class="bidding">
	                			...
	                			<td>
	                				...
	                				<div class="operation-tenders">
        								<a href="信息中心-我的标书-我参与的竞标详情页.html" class="chakan">查看更多</a>
        							</div>
	                			</td>
	                		</tr>
	                		<tr class="bid">
	                			<td>中秋节送礼</td>
	                			<td class="bid-status"><span>完成中标</span><a href="javascript:;">我已中标</a></td>
	                			<td>
	                				<div class="infor-companyTenders">南山科技园 - 李生 - 15084904908 - 深圳市XXX公司</div>
	                				<div class="list-companyTenders">
	                					<ul>
