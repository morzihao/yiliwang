     ...
     <div  class="member_left_menu">
      ...
      <!-- 我的会员卡右侧 -->
        <div class="member_right">
          ...
          <div class="content">
            <div class="txt-cgfb">
              <p style=" background:none; height:auto;margin-bottom: 10px;  font-size:45px;">您好！您申请成为供应商正在审核中...
      </br>请耐心等待审核结果！
      </p>
      <span style=" display: block; height:40px;margin-bottom: 100px; line-height: 40px; color: #666; font-size: 16px; text-align: center; font-family: 微软雅黑;">审核结果将在两个工作日内以手机短信的形式告知您，敬请关注!</span>
            </div>
          </div>
