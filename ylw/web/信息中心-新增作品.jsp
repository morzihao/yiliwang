         	...
         	<div class="content">
        		<form action="#" class="form-horizontal" id="registerForm">
                    <div class="control-group">
                        <label for="works-intro" class="control-label"><span>*</span>作品说明：</label>
                        <div class="controls">
                              <input id="works-intro" name="works-intro" class="required works-intro w400" />
                            <span class="help-inline"></span>
                        </div>
                    </div>
        			<div class="control-group">
        				<label for="" class="control-label"><span>*</span>作品图片:</label>
        				<div class="controls" id="ImgUpBox" style="width:85%;">
                            <!-- img -->
                            <div class="img-outside">
                                ...
                                <div class="clear"></div>
                                <a href="javascript:;" class="shanchu-xz">删除</a>
                          </div>
                           <!-- img over-->
                           <!-- img -->
                            <div class="img-outside">
                    ...
                    <div class="control-group">
                        <label for="select01" class="control-label" ><span>*</span>类别：</label>
                        <div class="controls">
                     ...
                     <div class="control-group">
                        <label for="select02" class="control-label" ><span>*</span>案例风格：</label>
                        <div class="controls">
                      ...
                      <div class="control-group">
                        <label for="prices" class="control-label"><span>*</span>价格：</label>
                        <div class="controls">
                              <input id="prices" name="prices" class="required works-intro w70" />
                              <em>元</em>
                            <span class="help-inline"></span>
                        </div>
                    </div>
        			<div class="control-group">
        				<div class="controls">
                            <input type="submit" class="btn btn-danger add-btn" value="提 交">
						</div>
        			</div>
        		</form>
        	</div>
