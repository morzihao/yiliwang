	                ...
	                <dd>
	                   <div class="column-inforTenders">
		                   	...
		                   	<div class="content-inforTenders">
		                   		<p>纪念日 -  古典风 - 1000元 -  张生 - 15274414091</p>
		                   	</div>
	                   </div>
	                    <div class="column-inforTenders">
		                   	<h6>任务简介：</h6>
		                   	<div class="content-inforTenders">
		                   	<p>在1000元范围内选择中秋节礼品，可以是一款产品页可以是多款产品，必须在中秋节前能把礼品送到</p>
		                   	</div>
	                   </div>
	                </dd>
                </dl>
				...
				<!-- 联系方式 -->
				 <dl class="add-sort page-floor">
	                ...
	                <dd>
	                	<div class="column-inforTenders">
		                   	<h6>设计师：</h6>
		                   	<div class="content-inforTenders"><em>张生 </em>-<span>15084904908</span></a>
		                   	</div>
	                   </div>
	                   <div class="column-inforTenders">
		                   	<h6>设计作品：</h6>
		                   	<div class="content-inforTenders">
		                   		<ul>
		                   			<li>
		                   				<div class="mask-queren"><img src="images/icons/bg-queren.png" alt=""></div>
		                   				<a href="javascript:;">
						    				<div class="list-pic">
										...
										<a href="javascript:;" class="queren">确认设计</a>
					    			</li>
					    			<li class="queren">
					    				<div class="mask-queren"><img src="images/icons/bg-queren.png" alt=""></div>
		                   				<a href="javascript:;">
